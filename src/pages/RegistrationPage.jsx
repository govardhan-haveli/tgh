...
export const RegistrationPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!primaryContact.name.trim()) {
      triggerError('Please enter your full name as the contact person.');
      return;
    }
    ...
    if (!paymentFile) {
      triggerError(`Payment screenshot is mandatory. Please scan QR code, pay ₹${totalPayable}, and upload the screenshot.`);
      return;
    }
    ...
    try {
      // Step 0: Check if Mobile Number already exists before uploading screenshot
      setSubmitStatusText('Checking mobile number...');
    ...
    <div className="min-h-screen bg-[#070b14] text-slate-100 py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-3xl sm:text-5xl font-black bg-gradient-to-r from-amber-100 via-amber-300 to-yellow-500 bg-clip-text text-transparent font-serif leading-tight">
            Janmashtami T-Shirt Registration
          </h1>
          <p className="text-slate-300 text-xs sm:text-base max-w-lg mx-auto leading-relaxed">
